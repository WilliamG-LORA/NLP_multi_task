...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/home/gzy/workspace/CPM/nlpdata/chid", type=str, help="The input dir of original ChID data.")
    parser.add_argument("--tokenizer_path", type=str, help="The tokenizer path.", default="./bpe_3w_new")
    parser.add_argument("--output_dir", default="/home/gzy/workspace/CPM/CPM-1-Finetune/data/chid", type=str, help="The processed data output dir.")
